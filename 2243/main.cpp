...
int main(int argc, char** argv)
{
    ...
    segment_tree<int, sum<int>> candy_box(1000000);
    ...
    while (N--)
    {
        ...
        case 1:
        {
            ...
            size_t taste = candy_box.index_query(nth_index<size_t>{ nth });
            cout << (taste + 1) << '\n';

            int current = candy_box.get(taste);
